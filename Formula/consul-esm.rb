class ConsulEsm < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://hashicorp-releases.yandexcloud.net/consul-esm/0.11.0/consul-esm_0.11.0_darwin_amd64.zip"
    sha256 "bb9783119c7eb2fbd0040354c1aa382f34eeb70cbf2aa5925f1a0cc55646201b"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "https://hashicorp-releases.yandexcloud.net/consul-esm/0.11.0/consul-esm_0.11.0_darwin_arm64.zip"
    sha256 "7481e79f756c544b283c2162f05c812ff841b83804f09ac18f5caea3220be810"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "https://hashicorp-releases.yandexcloud.net/consul-esm/0.11.0/consul-esm_0.11.0_linux_amd64.zip"
    sha256 "75a3b92f8cd5dd9d3264a5ccc9b3e09a2b36f8d73e7853450dc0b42637b94ed2"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "https://hashicorp-releases.yandexcloud.net/consul-esm/0.11.0/consul-esm_0.11.0_linux_arm.zip"
    sha256 "f380c4eeb03b21aabd0b4d67b2a3ff348261b72481b4a1232b566f859f434089"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "https://hashicorp-releases.yandexcloud.net/consul-esm/0.11.0/consul-esm_0.11.0_linux_arm64.zip"
